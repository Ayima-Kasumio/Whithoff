...
def dessiner_cercle(position, taille, couleur, t):
    t.color(couleur)
    t.up()
    t.goto(position)
    t.down()
...
def dessiner_boite_mystère(position, taille, t):
    t.pensize(6)
    t.color("black", "yellow")
    t.up()
    t.goto(position[0]-taille//2, position[1]-taille//2)
    t.down()
    ...
    dessiner_cercle((position[0]-6.5*taille//19, position[1]+5.5*taille//19), taille//16, ("#cccc00", "black"), t)
    dessiner_cercle((position[0]-6.5*taille//19, position[1]-7.5*taille//19), taille//16, ("#cccc00", "black"), t)
    dessiner_cercle((position[0]+6.5*taille//19, position[1]+5.5*taille//19), taille//16, ("#cccc00", "black"), t)
    dessiner_cercle((position[0]+6.5*taille//19, position[1]-7.5*taille//19), taille//16, ("#cccc00", "black"), t)
...
dessiner_boite_mystère((0,0), taille, tc)
